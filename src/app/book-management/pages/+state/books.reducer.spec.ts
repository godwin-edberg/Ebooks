...
import { BooksDetail, generateMockBook } from 'src/app/models/books-detail';
...
describe('BooksReducer', () => {
  ...
  describe(
    ...
    () => {
      function addBookToCart(booksInitialState: any, expected) {
  ...
  describe(
    'able to remove book from the cart when clicked on remove button' +
      ' on the book list',
    () => {
      function removeBookFromCart(booksInitialState: any, expected) {
